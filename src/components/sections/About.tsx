...
export default function About() {
  ...
  return (
    <section id="about-details" className="py-24 sm:py-32 bg-[#f9fafb] font-sans border-b border-[#e5e7eb]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6">
            <div
              ...
              className="relative rounded-[24px] bg-gradient-to-br from-[#1e1b4b] to-[#312e81] p-12 overflow-hidden min-h-[440px] shadow-xl group border border-indigo-950 flex flex-col justify-between cursor-pointer"
            >
              
              {/* LARGE DECORATIVE CIRCLES */}
              {/* Large top-right outline circle */}
              <div className="absolute -top-10 -right-10 w-[200px] h-[200px] border-2 border-white/10 rounded-full pointer-events-none transition-transform duration-700 group-hover:scale-110"></div>
              
              {/* Medium bottom-left filled glow circle */}
              <div className="absolute bottom-[60px] left-[40px] w-[120px] h-[120px] bg-indigo-500/30 rounded-full blur-2xl pointer-events-none"></div>
              ...
              <div className="bg-white/95 backdrop-blur-md rounded-[12px] p-5 shadow-2xl relative z-10 w-full max-w-[280px] self-start border border-slate-200">
                ...
                <div className="font-mono text-xs text-slate-800 space-y-1 select-none">
                  <p>
                    <span className="text-indigo-600 font-bold">const</span>{' '}
                    <span className="text-[#1e1b4b] font-bold">mantu</span> = {'{'}
                  </p>
                  <p className="pl-4">
              ...
              <AnimatePresence>
                {hoveredCard && (
                  <motion.div
                    ...
                    className="absolute bottom-5 left-5 right-5 bg-white rounded-[14px] p-5 shadow-2xl border border-slate-200/50 z-20 space-y-3"
                  >
                    <p className="text-[#2563eb] text-[10px] font-mono font-bold tracking-widest uppercase border-b border-slate-100 pb-2">
                      ✦ Profile Credentials
                    </p>
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="space-y-3">
              <span className="text-xs uppercase font-mono font-bold text-[#2563eb] tracking-widest block">
                01. ABOUT ME
              </span>
              <h2 className="text-4xl sm:text-5xl font-black text-[#0f0f1a] leading-[1.1] tracking-tight">
                We help you build <br />
                the{' '}
                <span className="relative inline-block">
                  best products
                  {/* Yellow underline */}
                  <span className="absolute left-0 bottom-1 w-full h-[6px] bg-[#ffd60a] -z-10 rounded-full opacity-90"></span>
                </span>
              </h2>
            </div>
